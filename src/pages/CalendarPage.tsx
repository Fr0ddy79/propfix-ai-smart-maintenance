                      ...
                      <div
                        ...
                        className={`p-2.5 rounded-lg border text-left transition-colors cursor-pointer ${
                          event.status === "urgent"
                            ...
                            ? "border-status-in-progress/20 bg-status-in-progress/5 hover:bg-status-in-progress/10"
                            : "border-border bg-card hover:bg-muted/30"
                        }`}
                      >
                        <div className="text-xs font-medium text-primary tabular-nums mb-1">{event.time}</div>
                        <div className="text-xs font-medium text-foreground mb-1 leading-snug">{event.title}</div>
